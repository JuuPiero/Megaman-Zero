Shader "Toony Colors Pro 2/Standard PBS Outline (Specular)"
{
	Properties
	{
	...
	SubShader
	{
		...
		//Outlines
		UsePass "Toony Colors Pro 2/Outline Only/OUTLINE"
	...
	SubShader
	{
		...
		//Outlines
		UsePass "Toony Colors Pro 2/Outline Only (Shader Model 2)/OUTLINE"
