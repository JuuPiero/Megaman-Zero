Shader "Toony Colors Pro 2/Standard PBS Outline Blended (Specular)"
{
	Properties
	{
	...
	SubShader
	{
		...
		//Outlines
		UsePass "Toony Colors Pro 2/Outline Only/OUTLINE_BLENDING"
	...
	SubShader
	{
		...
		//Outlines
		UsePass "Toony Colors Pro 2/Outline Only (Shader Model 2)/OUTLINE_BLENDING"
