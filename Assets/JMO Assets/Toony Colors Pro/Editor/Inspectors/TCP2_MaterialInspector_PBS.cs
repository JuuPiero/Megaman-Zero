...
internal class TCP2_MaterialInspector_PBS : ShaderGUI
{
	...
	void SetTCP2Shader( bool useOutline, bool blendedOutline )
	{
		...
		{
			if (specular)
				shaderPath = "Toony Colors Pro 2/Standard PBS Outline Blended (Specular)";
			else
				shaderPath = "Toony Colors Pro 2/Standard PBS Outline Blended";
		}
		else
		{
			if (specular)
				shaderPath = "Toony Colors Pro 2/Standard PBS Outline (Specular)";
			else
				shaderPath = "Toony Colors Pro 2/Standard PBS Outline";
		}
